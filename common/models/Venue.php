...
class Venue extends \yii\db\ActiveRecord {
    ...
    public function rules() {
        return [
            [['user_uuid', 'venue_name', 'venue_contact_email', 'occasion_uuid'], 'required'],
            [['user_uuid', 'venue_capacity_minimum', 'venue_capacity_maximum', 'occasion_uuid'], 'integer'],
    ...
    public function afterSave($insert, $changedAttributes) {
        ...
        if ($insert) {
            ...
            $venue_occasion_model->occasion_uuid = $this->occasion_uuid;
